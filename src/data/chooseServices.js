export const chooseServices = [
  {
    serviceId: 1,
    serviceTitle: "Home Relocation Made Easy",
    whyChooseUs:
      "We move your home with smart helpers and calm planning. We always work with care to make sure your move is smooth and safe. That’s why many people trust us.",
    features: [
      {
  ...
  {
    serviceId: 2,
    serviceTitle: "Apartment Relocation",
    whyChooseUs:
      "Leaving a flat is not easy work, but we make it a piece of cake. We just know the trick to getting around tight corners. We ensure that your move goes on perfectly right from beginning to end.",
    features: [
      {
  ...
  {
    serviceId: 3,
    serviceTitle: "International Moving Services",
    whyChooseUs:
      "Crossing borders? We manage international relocations with precision. From documents to delivery, everything is handled smoothly and securely.",
    features: [
      {
  ...
  {
    serviceId: 4,
    serviceTitle: "Mazda Shehzore Rentals",
    whyChooseUs:
      "Need a truck for your goods? We rent a Mazda Shehzore with expert drivers and full care.",
    features: [
      {
  ...
  {
    serviceId: 5,
    serviceTitle: "Storage Box Transports",
    whyChooseUs:
      "Your storage boxes must be handled carefully, the thing which we are doing. Long distance and short distance journeys, all must be handled carefully.",
    features: [
      {
  ...
  {
    serviceId: 6,
    serviceTitle: "Furniture Moving",
    whyChooseUs:
      "Big pieces or little pieces, we know just what to do with it. We take care of that each piece needs.",
    features: [
      {
