      ...
      <div className='sen-user-modal'>
        ...
        <div className='sen-user-modal-container'>
          ...
          <ul className='sen-switcher'>
            <li>
              <Link href='#0'>Sign in</Link>
            </li>
            <li>
              <Link href='#0'>Sign up</Link>
            </li>
          </ul>
          <div id='sen-login'>
            {" "}
            ...
            <form className='sen-form'>
              ...
              <p className='fieldset'>
                ...
                />
                <Link href='#0' className='hide-password'>
                  Hide
                </Link>
                <span className='sen-error-message'>Error message here!</span>
              </p>
            ...
            {/* <Link href="#0" class="sen-close-form">Close</Link> */}
          </div>{" "}
          {/* sen-login */}
          <div id='sen-signup'>
            {" "}
            ...
            <form className='sen-form'>
              ...
              <p className='fieldset'>
                ...
                <label htmlFor='accept-terms'>
                  I agree to the <Link href='#0'>Terms</Link>
                </label>
              </p>
              <p className='fieldset'>
                <input
          ...
          <div id='sen-reset-password'>
            ...
            <p className='sen-form-bottom-message'>
              <Link href='#0'>Back to log-in</Link>
            </p>
          </div>{" "}
          {/* sen-reset-password */}
          <Link href='#0' className='sen-close-form'>
            Close
          </Link>
        </div>{" "}
