...
const NavbarOne = () => {
  ...
  useEffect(() => {
    // Control sidebar navigation on the client only
              ...
              <ul className="navbar-nav menu-open">
                ...
                <li className="menu-item-has-children">
                  ...
                  <ul className="sub-menu">
                    ...
                    <li>
                      <a href="/office-relocations">Office Shifting</a>
                    </li>
                    <li>
                      <a href="/house-moving-company">Home Shifting</a>
                    </li>
                    <li>
                      <a href="/house-moving-company">
                        Home & Office Relocation
                      </a>
                    </li>

                    <li>
                      <a href="/shehzore-mazda-for-rent">
                ...
                <li className="menu-item-has-children">
                  ...
                  <ul className="sub-menu">
                    ...
                    <li>
                      <a href="/service-details">Service Details Page</a>
                    </li>
                    <li>
